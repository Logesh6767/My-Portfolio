          ...
          >
            {skillCategories.map((category, index) => (
              ...
              >
                ...
                <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-gray-900/5 to-transparent rounded-bl-full scale-0 opacity-0 translate-x-12 -translate-y-12 group-hover:scale-100 group-hover:opacity-100 group-hover:translate-x-0 group-hover:translate-y-0 transition-all duration-500 ease-out"></div>
                    ...
                    <div key={idx} className="group/skill">
                      <div className="flex justify-between items-center mb-2.5">
                        <div className="flex items-center space-x-2.5">
                          <div className="text-gray-700 group-hover/skill:text-gray-900 transition-all duration-300 group-hover/skill:scale-110 group-hover/skill:rotate-12">
                            {skill.icon}
                          </div>
                          <span className="text-gray-800 font-semibold text-sm tracking-wide">{skill.name}</span>
                        </div>
                        <motion.span 
                          className="text-gray-600 text-sm font-bold px-2.5 py-0.5 bg-gray-100 rounded-full group-hover/skill:bg-gray-900 group-hover/skill:text-white transition-colors duration-300"
                          initial={{ opacity: 0 }}
                      ...
                      <div className="relative w-full bg-gray-200 rounded-full h-2.5 overflow-hidden">
                        ...
                        <motion.div
                          ...
                          className="relative h-2.5 bg-gradient-to-r from-gray-800 via-gray-900 to-gray-800 rounded-full shadow-sm"
                        >
          ...
          >
            {softSkills.map((skill, index) => (
              <motion.span
                ...
                className="group relative bg-gradient-to-br from-white to-gray-50 px-6 py-3 rounded-xl border-2 border-gray-200 text-gray-800 font-semibold hover:text-gray-900 hover:shadow-lg transition-all duration-300 cursor-default overflow-hidden"
              >
                {/* Small decorative element */}
                <div className="absolute top-0 right-0 w-8 h-8 bg-gradient-to-bl from-gray-900/10 to-transparent rounded-bl-full scale-0 group-hover:scale-100 transition-transform duration-300"></div>
                ...
                <span className="relative z-10 flex items-center justify-center gap-0 group-hover:gap-2 transition-all duration-300">
                  ...
                  <span className="inline-flex w-0 opacity-0 overflow-hidden group-hover:w-4 group-hover:opacity-100 transition-all duration-300">
                    {skill.icon}
                  </span>
            ...
            {education.map((edu, index) => (
              ...
              >
                ...
                {index !== education.length - 1 && (
                  <div className="absolute left-3 top-8 bottom-0 w-0.5 bg-gray-200 group-hover:bg-gray-400 transition-colors duration-300"></div>
                )}
                
                {/* Timeline dot */}
                <motion.div 
                  className="absolute left-0 top-2 w-6 h-6 bg-gradient-to-br from-gray-900 to-gray-700 rounded-full flex items-center justify-center shadow-md group-hover:shadow-lg group-hover:scale-110 transition-all duration-300"
                  whileHover={{ rotate: 360 }}
                  transition={{ duration: 0.6 }}
                >
                ...
                <div className="relative bg-gradient-to-br from-white via-gray-50 to-white rounded-2xl p-6 border border-gray-200 shadow-lg hover:shadow-2xl ml-4 transition-all duration-300 overflow-hidden group-hover:scale-[1.02]">
                  {/* Decorative gradient overlay - top left */}
                  <div className="absolute top-0 left-0 w-28 h-28 bg-gradient-to-br from-gray-900/5 to-transparent rounded-br-full scale-0 opacity-0 -translate-x-12 -translate-y-12 group-hover:scale-100 group-hover:opacity-100 group-hover:translate-x-0 group-hover:translate-y-0 transition-all duration-500 ease-out"></div>
                  
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-3 relative z-10">
                    <h4 className="text-xl font-bold text-gray-900 group-hover:text-gray-800 transition-colors duration-300">
                      {edu.degree}
                    </h4>
                    <motion.span 
                      className="text-sm font-bold text-gray-700 mt-2 sm:mt-0 px-3 py-1 bg-gray-100 border border-gray-200 rounded-lg shadow-sm"
                  ...
                  <p className="text-gray-700 mb-3 font-medium relative z-10">{edu.institution}</p>
